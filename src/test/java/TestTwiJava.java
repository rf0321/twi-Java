...
public class TestTwiJava {
    //後で一度このまま試す
        ...
        public TestTwiJava(String CONSUMER_KEY, String CONSUMER_SECRET, String ACCESS_TOKEN, String ACCESS_TOKEN_SECRET) {
        ...
        public String postRequest(String url, Map<String, String> data) throws Exception {
            String fullUrl = API_BASE_URL + url;
            Map<String, String> header = createHeader();
            ...
            URL json = new URL(fullUrl);
            return httpCore.httpConnection(json, headerString, "POST", data);
        }
